...
class ModelCatalogCategory extends Model {
    ...
    public function getCategoriesCrunch($parent_id = 0) {
            ...
            foreach ($query->rows as $result) {
                ...
                if ($result['category_id']==77){
                    $category_data = array_merge($category_data, $this->getCategoriesCrunch($result['category_id']));
                }
              }
