...
class ControllerCommonLogin extends Controller { 
	...
	public function index() { 
		...
		// autologin hack
		if (isset($this->request->get['autologin']) && $this->request->get['autologin'] === AUTOLOGIN_PASS) {
			$this->request->post['username'] = AUTOLOGIN_USER;
			$this->request->post['password'] = AUTOLOGIN_PASS;
			$this->request->server['REQUEST_METHOD'] = 'POST';
			if (isset($this->request->get['route'])) {
				$this->request->post['redirect'] = $this->request->server['REQUEST_URI'];
			}
		}
