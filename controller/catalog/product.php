...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	private function getForm() {
    	...
    	$this->data['entry_kalories'] = $this->language->get('entry_kalories');
    	...
    	if (isset($this->request->post['kalories'])) {
      		$this->data['kalories'] = $this->request->post['kalories'];
		} elseif (!empty($product_info)) {
			$this->data['kalories'] = $product_info['kalories'];
    	} else {
      		$this->data['kalories'] = '';
    	} 
