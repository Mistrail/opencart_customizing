...
<?/* */?><script type="text/javascript" src="view/javascript/jquery/jquery-1.12.4.js"></script><?/* */?>
...
<body <?php if ($this->config->get('is_iframe')) { ?>class="iframe"<?php } ?>>
<?php if (!$this->config->get('is_iframe')) { ?>
<div id="container">
<div id="header">
  <div class="div1">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="callcenter"><a class="top">Колцентр</a>
        <ul>
          <li><a href="<?php echo $this->url->link('extra/order', 'token=' . $this->session->data['token']); ?>">Оператор</a></li>
          <li><a href="<?php echo $this->url->link('extra/order/all', 'token=' . $this->session->data['token']); ?>">Кассир</a></li>
          <li><a href="<?php echo $this->url->link('extra/order/add', 'token=' . $this->session->data['token']); ?>">Добавить заказ</a></li>
        </ul>
      </li>
...
<?php } else { ?>
<style type="text/css">
body, td, th, input, select, textarea, option, optgroup, .htabs a {
  font-size: 14px;
}
</style>
<script type="text/javascript"><!--
